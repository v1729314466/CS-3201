...
public class AntTester
{
    public static void main( String args [])
    {
        ...
        ArrayList<Integer> notVisited = testAnt.notYetVisited(visited);
        ArrayList<Integer> lengths = testAnt.edgeLengths(currentNode, correctNotVisited);
        ArrayList<Double> levels = testAnt.pheromoneLevels(currentNode, correctNotVisited);
        ArrayList<Double> probabilities = testAnt.edgeProbs(correctLevels, correctLengths);
        ArrayList<Double> cumulative = testAnt.cumulativeProbs(correctProbs);
        ...
        // call selectNextNode() 1000 times from the same starting node
        int [] timesChosen = new int [numNodes];
        for (int count = 0; count < 10000; count ++)
        {
            int chosen = testAnt.selectNextNode(correctCumulative);
        ...
        System.out.println("Run selectNextNode 10000 times from starting node " + currentNode + ":\n");
